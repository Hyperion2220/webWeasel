# This script can be run with: uv run crawl4AI.py --url "https://example.com"
...
def parse_args():
    parser = argparse.ArgumentParser(description="Web crawler for AI-powered content extraction")
